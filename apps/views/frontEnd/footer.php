			...
			<div class="row">
				...
				<div class="col-sm-6 col-lg-3 footer-widget">
					<div class="about-widget">
						<img src="apps/public/img/logo-light.png" alt="">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
	...
	<script src="apps/includes/frontEnd/js/owl.carousel.min.js"></script>
	<script src="apps/includes/frontEnd/js/jquery.countdown.js"></script>
	<script src="apps/includes/frontEnd/js/masonry.pkgd.min.js"></script>
	<script src="apps/includes/frontEnd/js/magnific-popup.min.js"></script>
	<script src="apps/includes/frontEnd/js/main.js"></script>
